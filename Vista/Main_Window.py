...
class MainWindow(QtGui.QWidget):
    ...
    def init_ui(self):
        ...
        button_login_empleado.clicked.connect(self.controlador.autenticateE)
        button_atras_tv = QtGui.QPushButton('atras')
        button_atras_tv.clicked.connect(self.controlador.show_sv)
        layout_grid_tv.addWidget(button_atras_tv)
        ...
        button_atras_cv = QtGui.QPushButton('Atras')
        button_atras_cv.clicked.connect(self.controlador.show_sv)
        ...
        layout_grid_cv.addWidget(button_atras_cv)
        ...
        button_atras_qv = QtGui.QPushButton('Atras')
        button_atras_qv.clicked.connect(self.controlador.show_sv)
        ...
        layout_grid_qv.addWidget(button_atras_qv)
